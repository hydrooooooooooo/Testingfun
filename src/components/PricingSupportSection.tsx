...
export default function PricingSupportSection() {
  return (
    <section className="mx-auto w-full max-w-2xl mt-14 mb-8 animate-fade-in">
      <Card className="bg-blue-50 bg-opacity-60 border-blue-100 rounded-2xl shadow-lg">
        <CardContent className="py-7 px-4 md:px-7 flex flex-col items-center gap-3">
          <div className="flex flex-row items-center gap-2 mb-2">
            <HelpCircle className="text-blue-700" size={22} />
          ...
          <div className="mt-2 text-xs text-muted-foreground text-center">
            ...
            <span className="italic">Exemple : ID scraping : <code className="font-mono px-1 text-blue-700/80">scrape_xxxxxx</code> – ID Dataset : <code className="font-mono px-1 text-blue-700/80">ds_xxxxxx</code></span>
          </div>
        </CardContent>
      </Card>
    </section>
